...
<section class="container-prose">
  ...
  <div class="mt-8 space-y-6 text-ink-700 leading-relaxed">
    ...
    <p>
      Before Jazz, I was at TeleCard, Kore Digital, and Artribe BPO — building Laravel and Node
      applications, leading small project teams, and learning what it takes to ship in resource-constrained
      environments.
    </p>
    ...
    <p>
      When I'm not at a keyboard, I'm usually under the hood of a 1987 Honda Civic with a carbureted
      D16 swap — an ongoing hobby project that has taught me more about patience and root-cause
      analysis than most CS courses.
    </p>
